...
public class CategoryByLectureAll {
    ...
    //wishList
    private int wishBool; // 사용자가 wishList를 눌렀는지 확인
    private String empId;

    public CategoryByLectureAll(){

    }

    public CategoryByLectureAll(int lectureId, String lectureTitle, String lectureUrl, int validYn, int onlineYn, int lectureBestYn, int categoryId, String academyId, String eduLevelId, int themeLectureId, int requiredLectureId, int academySubjectId, String academyName, String academyLoc, String academyUrl, String academyDetails, String academyLogoUrl, int wishBool, String empId) {
