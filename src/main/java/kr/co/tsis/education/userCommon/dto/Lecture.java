...
public class Lecture {
    ...
    public Lecture(int lectureId, String lectureTitle, String lectureUrl, int validYn, int onlineYn, int lectureBestYn, int categoryId, String academyId, String eduLevelId, int themeLectureId, int requiredLectureId, int academySubjectId) {
